...
try:
    ...
    stop_words = {
        ...
        "adalah","dalam","tidak","akan","juga","karena","ada","saya","kami",
        "kita","mereka","ia","dia","anda","kamu","sudah","telah","bisa",
        "dapat","harus","lebih","sangat","atau","jika","maka","tetapi",
        "namun","oleh","hingga","sehingga","setelah","sebelum","ketika",
        "saat","bagi","bahwa","atas","bawah","antara","sejak","selama",
        "sekitar","seperti","tentang","terhadap","melalui","per","para",
        "pun","pula","lagi","lain","hal","hari","tahun","kali","cara",
        "saja","masih","belum"
    }
